+++
title = "cadi"
header_title = "Cadi | Yellow Body Blue Bar | Ambilobe Panther Chameleon"
date = "2023-03-17"
tags = ["cadi", "cadillac", "atlas", "amarillo"]
categories = ["ambilobe-dams"]
banner = "img/ambilobe/cadi/cadi"
+++

{{< load-photoswipe >}}

Cadi is a great YBBB produced by Longshot Chameleons (Bryan Long) with a male from our Arti x Daisy pairing named Cadillac. Her brother, Sideshow, is one of the best we have ever seen, so we are excited to add her to our program and see what she brings!


{{< no_num_gallery dir="/img/ambilobe/cadi" more=" | Ambilobe Panther Chameleon" />}}
...
{{< rawhtml >}}
  <div id="grampstextdoc">
    <div id="header">
      <h1>Ancestral Report for Cadi (F5-CG14)</h1>
    </div>
    <h3>Generation 1</h3>
    <img align="right" alt="" border="0" src="iscadi1.jpg" />
    <p>1. <strong>Cadi (F5-CG14). </strong>Cadi was produced by Longshot Chameleons.  She is the daughter of Cadillac (F4-CG13) and Jane (F4-CG6). </p>
    <p>More about Cadi (F5-CG14):</p>
    ...
    <p>i. Cadi (F5-CG14) [1]. Cadi was produced by Longshot Chameleons.  </p>
    <p>ii. Smiles (F5-CG14). </p>
    <p>iii. Sideshow (F5-CG14). </p>
    <h3>Generation 3</h3>

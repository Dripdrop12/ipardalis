...
**Haplogroup**: a group of simiar haplotypes that share a common ancestor
...
We will report the mtDNA haplogroup match for each available haplogroup followed by % unknown. There are a few popular locales that Grbic et al. did not sequence (Tamatave, Ankaramy, etc), so those will be gaps that we need to fill in future iterations of the test.
...
Donald Hedger, Stephanie Payne, Debbie Tobar, Erik Flores (Hill Country Chameleons), Julie Mokry, Leigh Hrutkay (Cloud9Chameleons), Corey Zetterman, Nicole Park, Isaac Martin Giacobone Schwartz, Sean Fogarty, Zachary Williford, Emily Lunsford

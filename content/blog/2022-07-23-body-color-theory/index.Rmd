...
Furcifer pardalis do not exhibit simple dominant, co-dominant or recessive trait inheritance of their body color. As you can see from our [past clutches](https://ipardalis.com/categories/past-clutches/), every single individual is completely unique. They all lie on a spectrum with a huge variety of outcomes. Given that body color is not a discrete outcome that can be mapped directly, one-to-one, to a single trait, we started searching for a useful genetic explanation for this. We believe that is because body color is determined by a complex genotype and many different genes in concert. That is called a [polygenic trait](https://www.genome.gov/genetics-glossary/Polygenic-Trait).

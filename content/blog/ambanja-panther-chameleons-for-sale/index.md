...
Many people in the chameleon community use the term blurple panther chameleon to refer to a locality cross among Nosy Be, Ambilobe and Ambanja locality Panther Chameleons, but that term has also been used by some old school breeders to describe a wild-type Ambanja phenotype with red and blue mixed bars. For the current generation of wild-type Ambanja breeders, blurple is a pejorative term we use to imply designer locality cross. A blurple Ambanja or a blue Ambanja is not a wild-type Ambanja. They are also not pure Ambanja. As this became well known about blurples, some breeders began to call them "blue Ambanja" to distinguish from their uglier cousins floating around in the market, but don't be fooled. They are all the same thing. And their clashing mish-mash of color only hits on something that resembles purple or deep blue once in a blue moon - most of the time, they mature into wholesale quality adults. So you could spend thousands on a baby, but are likely to just find yourself holding the bag in 12 months.

The wild Ambanja phenotype is more often a pixelated red/blue that genetically can throw more red and less blue or more blue and less red in the next generation - similar to Ambilobe bars, but different shades of red and blue and higher degrees of pixelation in Ambanja.
...
## Conclusion
There are a lot of stories in the Ambanja breeding community about how Ambanja are "special" and "different from other local forms." This is because they are traditionally a three-way Ankify, Ambato and Ambanja cross, and blurples have most likely thrown Nosy Be and Ambilobe in to make it a 3-to-5-way locale cross combination. That is definitely hard to predict from a phenotypic/breeding standpoint, and it does exhibit characteristics of other cross-locale combinations. There is no genetic explanation for why a species would form semi-consistent phenotypes in one location and helter skelter rainbow phenotypes somewhere else. We should skeptically view the notion that a local form is "more diverse than any other" - it is much more likely to be multiple local forms combined into one.

There are plenty of projects in which people breed pure Ankify, Ambato and Ambanja. We would make their lives much easier if we helped new people understand the challenge and prevented them from repeating the mistakes of the past. At some point, the importation process will not be an option and our captive bred Ambanja will be all that is left for us to continue the phenotype in captivity. I believe we should manage the captive-bred Ambanja population well and prepare for a future where we don't have access to fresh, wild-type Ambanja. It is probably just around the corner. Let's list specimens under Ambanja Panther Chameleons for sale that are wild-type Ambanja phenotypes in the future.

...
This plot shows one line per neonate with three weight measurements taken on the same date. You can see the growth rate from the change in distance from left to right. The color indicates what the maximum UVI was for a given neonate.
